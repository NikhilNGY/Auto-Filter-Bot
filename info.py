...
# Bot information
API_ID = environ.get('API_ID', '2468192')  #api id of your telegram id
if len(API_ID) == 0:
    print('Error - API_ID is missing, exiting now')
    exit()
else:
    API_ID = int(API_ID)
API_HASH = environ.get('API_HASH', '4906b3f8f198ec0e24edb2c197677678') #api hash of your telegram id
if len(API_HASH) == 0:
...
# Bot Admins
ADMINS = environ.get('ADMINS', '2068233407 2098589219') #apni tg id daalo
if len(ADMINS) == 0:
...
AUTH_CHANNEL = [int(auth_channels) for auth_channels in environ.get('AUTH_CHANNEL', '-1002055023335').split()]
if len(AUTH_CHANNEL) == 0:
    print('Info - AUTH_CHANNEL is empty')
LOG_CHANNEL = environ.get('LOG_CHANNEL', '-1001693006436') #bot log channel -1001693006436
...
# support group
SUPPORT_GROUP = environ.get('SUPPORT_GROUP', '-1001734119324') #support group id ex:  -1001734119324
...
# Bot settings
DELETE_TIME = int(environ.get('DELETE_TIME', 6000)) # Add time in seconds 
...
PAYMENT_QR = environ.get('PAYMENT_QR', 'https://envs.sh/t3L.jpg') #telegraph link of your QR code 
UPI_ID = environ.get('UPI_ID', '@Nikhil5757h') # Add your upi id here
# for stream
IS_STREAM = is_enabled('IS_STREAM', False) #true if you want stream feature active in your bot
BIN_CHANNEL = environ.get("BIN_CHANNEL", "-1001693006436") #if is_stream = true then add a channel id ex: -1001693006436
if len(BIN_CHANNEL) == 0:
    print('Error - BIN_CHANNEL is missing, exiting now')
    exit()
else:
    BIN_CHANNEL = int(BIN_CHANNEL)
URL = environ.get("URL", "https://applicable-elke-filterbott-6d3a7c09.koyeb.app/") #if heroku then paste the app link here ex: https://heroku......./
if len(URL) == 0:
